			...
			<div class='column-group'>
				<?php
					if (isset($_POST['numeroAuto'])){
						...
						$descricaoEspecificaMercadoria = $_POST['descricaoEspecificaMercadoria'];
                                                $SeparadoBagagem = $_POST['SeparadoBagagem'];
						...
						if (isset($_POST['id'])){
							$id = $_POST['id'];
							//editar
							$da->editarAutoMercadoriaA($id, $numeroAuto, $data, $hora, $nomeAutoado, $nacionalidade, $numPassaporte, $dataEmissaoPassaporte,
						    ...
						    $da->inserirAutoMercadoriaA($numeroAuto, $data, $hora, $nomeAutoado, $nacionalidade, $numPassaporte, 
							...
							$dataVoo, $separadorBagagem, $revisorBagagem, $descricao, $numProcessoContraOrdenacao, 
                                                        $descricaoEspecificaMercadoria, $SeparadoBagagem, $idUtilizador);
				...
				<?php
					...
					include('AutoMercadoriaAHTML.php');
				?>
			</div>
		</div>
	</body>
