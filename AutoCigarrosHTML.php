<?php
	function verFormularioCriarAuto(){
		...
		<div class='large-75 medium-75 small-100'>
			<div class='ink-grid'>
				<form method='post' action='AutoCigarros.php' class='ink-form'>
				<fieldset>
					<legend>Criar Auto Cigarros</legend>
					...
					<div class='control-group'>
						<div class='control large-33'>
							...
							<input type='text' name='numProcessoContraOrdenacao' placeholder='xxx/".date('Y')."' required>
                                                ...
                                                <div class='control large-33'>
							<label for='name'>Número de Cigarros</label>
							<select name='numeroCigarros'>
                                                            <option value='-1'></option>
                                                            <option value='1'>Mais de 3000</option>
                                                            <option value='2'>3000 ou menos</option>
                                                        </select>
						</div>
					</div>
				...
				<div class='ink-grid'>
					<div class='control-group'>
						<div class='large-75 medium-75 small-75'>
						   <legend> Editar Auto Cigarros</legend>
                                                            ...
                                                            <div class='control large-33'>
                                                                ...
                                                                <select name='numeroCigarros'>
                                                                    ...
                                                                    ";
                                                                        ...
                                                                        if ($row['Descricao'] == "1"){
                                                                         echo " <option value='1' selected>Mais de 3000</option>
                                                                               <option value='2'>3000 ou menos</option>";   
                                                                        }else{
                                                                             echo " <option value='1'>Mais de 3000</option>
                                                                                    <option value='2' selected>3000 ou menos</option>";   
                                                                        }
                                                                         echo "
                                                                </select>
                                                            </div>
						...
						<div class='vertical-space'>
							<a target='_blank' href='pdfCigarros.php?i=".$_GET['i']."' class='ink-button black'>PDF</a>
