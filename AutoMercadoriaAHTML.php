...
function verFormularioCriarAuto(){
    ...
    $row = mysql_fetch_object($res);
		echo "<div class='large-75 medium-75 small-100'>
				<div class='ink-grid'>
					<form method='post' action='AutoMercadoria.php' class='ink-form'>
						<fieldset>
							<legend>Criar Auto Mercadoria</legend>
							...
							<div class='control-group'>
								...
								<div class='control large-33'>
                                    <label for='name'>Técnico Separador de Bagagem</label>
...
Com a conduta descrita o passageiro evitava o pagamento de (PREENCHER) (extenso) a título de imposições aduaneiras devidas pela introdução em consumo da mercadoria, nos termos do art. 79.º do CAC, de acordo com o mapa da dívida que se anexa e faz parte integrante do presente Auto.
								...
								<div class='control large-90'>
									...
									<textarea id='area' cols='70' rows='10' name='descricaoEspecificaMercadoria' required>
O passageiro declarou que a mercadoria seria destinada a (PREENCHER) e, como tal, alvo de reexportação, pelo que foi emitido o ticket nº (PREENCHER), para a mercadoria em causa ficando a mesma sob controlo aduaneiro.
Ou
...
Foi emitido o Separado de Bagagem n.º (PREENCHER), encontrando-se em curso o prazo para o cumprimento das formalidades aduaneiras previsto na alínea b) do n.º 1 art. 49.º do CAC.
									...
									<textarea id='area' cols='70' rows='10' name='SeparadoBagagem' required>
Foi emitido o Separado de Bagagem n.º (PREENCHER), folha (PREENCHER), caderneta (PREENCHER), encontrando- se em curso o prazo para o cumprimento das formalidades aduaneiras previsto na alínea b) do n.º1 do art. 49.º do CAC.
									</textarea>
...
function verFormularioEditarAuto($id){
	...
	$row = mysql_fetch_assoc($res); //n.º do auto
	 echo "<div class='large-75 medium-75 small-100'>
                    <div class='ink-grid'>
                        <form method='post' action='AutoMercadoria.php' class='ink-form'>
                            <fieldset>
                            <legend>Editar Auto Mercadoria</legend>
                            <div class='control-group'>
                                <div class='control large-33'>
	...
	echo "
					<div class='control-group'>
                                        <div class='control large-90'>
							<label for='name'>Descrição Especifica Mercadoria</label>
							<textarea id='area' cols='50' rows='6' name='descricaoEspecificaMercadoria' required>".$row['Descricao']."</textarea>
						</div>
					</div>
                                        ";
                                        $row = mysql_fetch_assoc($res);
        echo"
                                        ...
                                        <div class='control-group'>
                                        <div class='control large-90'>
							<label for='name'>Separado de Bagagem</label>
							<textarea id='area' cols='50' rows='6' name='SeparadoBagagem' required>".$row['Descricao']."</textarea>
						</div>
					</div>
					<div class='vertical-space'>
							<a href='pdfAutoMercadoriaA.php?i=".$_GET['i']."' class='ink-button black'>PDF</a>
