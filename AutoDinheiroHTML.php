<?php
    function verFormularioCriarAuto(){
	  ...
	  echo "<div class='large-75 medium-75 small-100'>
			    <div class='ink-grid'>
				    <form method='post' action='AutoDinheiro.php' class='ink-form'>
				        <fieldset>
					        <legend>Criar Auto Dinheiro</legend>
					            	...
					            	<div class='control large-33'>
                                                            <label for='name'>Nacionalidade</label>
                                                                <select name='nacionalidade'>
                                                                    ...
                                                                    echo"
					            	<div class='control large-33'>
                                                            <label for='name'>Nº do Passaporte</label>
					            		<input type='text' size='20' name='numPassaporte'required>
                                                    ...
                                                    <div class='control-group'>
                                                        <div class='control large-100'>
                                                            <label for='name'>Dinheiro que Transportava</label>
                                                            <textarea id='area' cols='50' rows='4' name='dinheiroQueTransportava' required></textarea>
				...
				<div class='ink-grid'>
					<div class='control-group'>
						<div class='large-75 medium-75 small-75'>
						   <legend> Editar Auto Dinheiro</legend>
						   <input type = 'hidden' name ='id' value ='$id'>
				 	                ...
				 	                <div class='control-group'>
			                            ...
			                            echo "<div class='control large-33'>
			                                ...
			                                echo "<div class='control large-33'>
			                                        <label for='name'>Hora</label>
			                                	    <input type='text' value='".$row['Descricao']."' name='hora'required>
                                                        </div>
                                                        </div>";
		                          	$row = mysql_fetch_assoc($res);
                                                ...
                                                echo "<div class='control large-33'>
                                                    ...
                                                    echo "<div class='control-group'>
                                                        <div class='control large-33'>
                                                         ...
                                                         $row = mysql_fetch_assoc($res);
                                                         echo "<div class='control large-66'>
                                                           ...
                                                           $row = mysql_fetch_assoc($res);
                                                            ...
                                                            $row = mysql_fetch_assoc($res); 
                                                                     echo "
                                                                         <div class='control large-100'>
                                                                                <label for='name'>Dinheiro que Transportava</label>
                                                                                <textarea id='area' cols='50' rows='4' name='dinheiroQueTransportava' required>".$row['Descricao']."</textarea>
                                                                        </div>
                                                                                   </div>";
                                                           ...
                                                           echo "
                                                            ...
                                                            <div class='vertical-space'>
                                                                    <a target='_blank' href='pdfdinheiroM.php?i=".$_GET['i']."' class='ink-button black'>PDF</a>
