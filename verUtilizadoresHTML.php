<?php
    ...
    $idCategoriaTecnico = $_POST['idCategoriaTecnico'];
        ...
        echo "<script>alert('Utilizador Atualizado com sucesso'); window.location='verUtilizadores.php'</script>";
    }
?>
<script>
...
<div class='large-75 medium-75 small-75'>	
	<table class="ink-table bordered alternating hover">
		<thead>
			<tr>
				<th class="content-left">Nome</th>
				<th class="content-left">E-Mail</th>
				<th class="content-left">Categoria</th>
			</tr>
		</thead>                 
		<tbody>
			<?php
				...
				while($row = mysql_fetch_assoc($res)){
					...
					echo "
						<tr>
							<td><a href='verUtilizadores.php?i=".$row['id']."'>".$row['nome']."</a></td>
							<td>".$row['email']."</td>
							<td>".$row['cat']."</td>
						</tr>
					";
...
<?php
    if(isset($_GET['i'])){
		...
		echo "
			<div class='large-75 medium-75 small-75'>    
				<form method='post' action='verUtilizadoresHTML.php' 
